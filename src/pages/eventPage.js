        ...
        <div className="relative container -mt-14 z-20 mx-auto ">
          <div className="grid sm:grid-cols-2 grid-cols-1 gap-x-5">
            <div className="w-72 sm:w-96 md:w-80 sm:ml-0 mx-auto">
              ...
              <div className="flex flex-row gap-5 mt-4 max-w-sm">
                <p className="text-yellow-500 mb-4 text-7xl font-serif">11</p>
            ...
            <div className="text-white mt-10 sm:mt-0 ml-0 md:ml-0 lg:-ml-32">
              ...
              <h2 className="text-lg mt-8">
                Help Artist India Is All Set For Major Musical Events 2023
                With... Big Artists Of The Industry ,It Will Be All For
                Fundraising For The NGO Dedicated To Upliftment Of Art And
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2">
            <div className="text-white mr-0 sm:-mr-10 md:mr-0">
              <h1 className="font-bold text-4xl sm:text-6xl">Shaam-e-Ghazal</h1>
              <h2 className="text-lg mt-10">
                Rumaniyat a musical night with Padma Shri Hariharan ,witness the
                mystic performance of living legend at F Bar and Lounge Noida
                BOOK YOUR TABLES NOW HURRY !!
            ...
            <div className="ml-0 sm:ml-36 md:ml-10 lg:ml-56">
              <div className="w-72 sm:w-96 md:w-80 mx-auto">
                ...
                <div className="flex flex-row gap-5 mt-4 ">
                  <p className="text-yellow-500 mb-4 text-7xl font-serif">14</p>
                  <div className="grid text-white">
                    <span>JULY</span>
                    <span>2023</span>
                    <span>FRIDAY</span>
