    ...
    return (
        <div>
            ...
            <div className='mb-8'>
                ...
                <div className='relative container mx-auto -mt-60 z-20  '>
                    <div className=' mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 w-3/4 rounded-3xl p-6  bg-neutral-800'>
                        <div>
                            <img src='/missionImg1.png' alt='missionImg' />
                        </div>
                        <div>
                            <img src='/missionImg2.png' alt='missionImg' />
                        </div>
                        <div>
                            <img src='/missionImg3.png' alt='missionimages' />
                        </div>
                        <div>
                            <img src='/missionImg4.png' alt='missionimages' />
                        </div>
                        <div>
                            <img src='/missionImg5.png' alt='missionimages' />
                        </div>
                        <div>
                            <img src='/missionImg6.png' alt='missionimages' />
                        </div>
                        <div>
                            <img src='/missionImg7.png' alt='missionimages' />
                        </div>
                        <div>
                            <img src='/missionImg8.png' alt='missionimages' />
                        </div>
                    </div>
                </div>
                ...
                <div className='relative container mx-auto mt-10'>
                    ...
                    <div className='text-center'>
                        ...
                        <ul className='text-lg  xl:bottom-40 lg:bottom-20 md:-bottom-28 sm:bottom-0 mt-10'>
                            <li className=' '>Musical training</li>
