...
function contact() {
  return (
    <main>
      ...
      <div>
        <section>
          <div className='bg-[url("/Rectangle.png")] h-96 w-full bg-cover bg-center p-20  text-white'>
                ...
                <div class="rounded-lg p-8 shadow-lg lg:col-span-3 lg:p-12">
                  ...
                  <div>
                    <p className="lg:text-lg md:text-lg">
                      Efficiently intergrate wirelss value whereas <br></br>{" "}
                      cross-platform e-trailers.
                    </p>
                  </div>
                  <form action="" className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      ...
                      <div>
                        ...
                        >
                          <option disabled="true" selected="Select Subject">
                            Select Subject
                          </option>
                          <option value="US">Writer</option>
                          <option value="CA">Actor</option>
                          <option value="FR">Director</option>
                          <option value="DE">Screen</option>
                        </select>
                      </div>
                    </div>
