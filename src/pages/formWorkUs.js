      ...
      <div className="flex flex-col justify-center  bg-[#0e101c]">
        <div className=" text-center  font-bold text-[#FFD12F]  p-10 border-b-2 border-[rgb(79,98,148)]">
          ...
          <p className="text-white mt-2">
            ...
            paragraphs or list items you want. You can also select to include
            HTML markup and specify how big the text should be. It currently
            supports standard Lorem Ipsum, Marvel Ipsum, Batman Ipsum and
            Pokemon Ipsum.
          </p>
        </div>
        ...
        <form className="flex flex-col gap-5 items-center m-10  text-white">
          <div className="flex flex-col md:flex-row gap-10 ">
            <div className="flex flex-col gap-5 ">
              ...
              <div className=" ">
                <label className=" font-extrabold" htmlFor="email">
                  Email<span className="text-red-500 text-[18px]"> *</span>
                </label>
                <input
                  className=" w-full border-4 rounded-md p-1   text-black   text-[14px] bg-white "
                  type="text"
            ...
            <div className="flex flex-col gap-5 ">
              <div className=" ">
                <label className=" font-extrabold" htmlFor="higherEdu">
                  Higher Education
                  <span className="text-red-500 text-[18px]"> *</span>
                </label>
                <input
              ...
              <div>
                <label className=" font-extrabold" htmlFor="experience">
                  Experience<span className="text-red-500 text-[18px]"> *</span>
                </label>
                <input
              ...
              <div className="">
                <label className=" font-extrabold" htmlFor="industry">
                  Industry<span className="text-red-500 text-[18px]"> *</span>
                </label>
                <input
                  className=" w-full border-4 rounded-md p-1 text-black   text-[14px] bg-white "
                  type="text"
              ...
              <div className="">
                <label className=" font-extrabold" htmlFor="aadhaar">
                  Aadhaar no.
                  <span className="text-red-500 text-[18px]"> *</span>
                </label>
                <input
              ...
              <div>
                <label className=" font-extrabold" htmlFor="uploadCv">
                  Upload CV<span className="text-red-500 text-[18px]"> *</span>
                </label>
                <input
