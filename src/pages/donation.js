    ...
    <div>
      ...
      >
        ...
        <div className="text-white ">
          “We can’t help every Artist we meet, but…Everyone can help at least
          one Artist”
        </div>
        <SelectArtist />
      </div>
      ...
      <div className=" grid justify-center md:flex md:justify-evenly  -mt-44 sm:mt-24">
        <div className=" max-w-lg text-center">
          ...
          <p className="text-2xl mx-4 ">
            ...
            giving.” <br /> You’r small contribution can make BIG changes{" "}
          </p>
        </div>
