                ...
                <div className='flex flex-col justify-center bg-[#0e101c]'>
                    <div className=' font-bold text-[#FFD12F]  p-10 border-b-2 border-[rgb(79,98,148)]'>
                        <h1 className='text-4xl text-center'>
                            HelpArtistIndia Partner
                        </h1>
                        {/* <p className='text-white mt-2'>
                            This free lorem ipsum generator lets you choose how
                            many sentences, paragraphs or list items you want.
                            You can also select to include HTML markup and
                            specify how big the text should be. It currently
                            supports standard Lorem Ipsum, Marvel Ipsum, Batman
