...
const Message = () => {
    return (
        <div>
            <div className='bg-[#0D0F27]  sm:h-[800px] p-8'>
                ...
                <section>
                    ...
                    >
                        ...
                        <div className='sm:flex sm:flex-row w-full justify-center  mt-16'>
                            ...
                            <div className='sm:w-3/4 mt-4 text-white w-full sm:px-14  sm:flex sm:flex-col text-xl'>
                                ...
                                Hain&quot;and many of the films are coming soon.
                        ...
                        {/*  */}
                        {/* 
                        <div className='sm:flex sm:flex-row w-full justify-center sm:pl-56 mt-16'>
                            <div className='sm:w-60  w-full '>
                                <video controls className='rounded-lg '>
                                    <source
                                        src='/bites3.webm'
                            ...
                            <div className='sm:w-3/4 mt-4 text-white w-full sm:p-14 sm:pr-28 sm:flex sm:flex-col text-xl'>
                                Turaz ,Aas Mohammed Chaudhary is a Young talent
                                in the world of cinema Writing Turaz is an
                                Indian poet, lyricist, and script writer. He has
                                worked in television too,Turaz wrote more than
