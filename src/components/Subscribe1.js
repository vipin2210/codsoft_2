...
const Subscribe1 = () => {
  return (
      <div className=' md:flex md:flex-row  items-center text-white justify-center py-5 gap-5 bg-[#000215]'>
          ...
          <div className=' flex flex-col items-center  text-black hover:text-white '>
              <div className='flex sm:flex-row flex-col w-[80%] items-center  gap-5  mb-5'>
                  <input
                      type='text'
                      className=' px-3 py-2 w-full mt-2 text-xl placeholder-gray-400 bg-gray-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-blue-600 focus:ring-opacity-50'
                      placeholder='Enter Your Email'
                  />

                  <button className='btn gap-2 p-3 md:w-[50%]  shadow-lg bg-white   hover:bg-red-600 rounded-2xl md:h-full flex flex-row justify-center '>
                      <svg
                          viewBox='0 0 448 512'
